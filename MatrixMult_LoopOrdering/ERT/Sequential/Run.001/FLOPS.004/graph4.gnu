...
set nox2tics
set noy2tics
set title "Graph 4 (Sequential/Run.001/FLOPS.004)"
...
set output "Sequential/Run.001/FLOPS.004/graph4.pdf"
plot "Sequential/Run.001/FLOPS.004/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
